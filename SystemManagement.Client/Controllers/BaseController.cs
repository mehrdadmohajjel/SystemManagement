...
using SystemManagement.Shared.AuthService;
using SystemManagement.Shared.Models.Base;
using SystemManagement.Shared.Models.DomainModels;
...
namespace SystemManagement.Client.Controllers
{
    ...
    {
        protected const string JwtKeyName = "MohajjelJsonWebToken";

        private const string BaseLoginDomain = @"http://localhost/";
